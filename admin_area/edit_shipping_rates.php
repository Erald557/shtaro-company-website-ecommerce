            ...
            <div class="col-sm-4"><!--col-sm-4 start-->
              <div class="form-group"><!--form-group start-->
                ...
                <input type="text" name="shipping_cost" class="form-control" required>
				   ...
				   <div class="form-group"><!--form-group start-->
             <div class="col-md-3">
				   	 	<input type="submit" name="submit" value="Insert Shipping Rate" class="btn btn-primary form-control">
            </div>
           </div><!--form-group end-->
				</form><!--form end-->
        <br>
        <br>
        <table class="table table-hover table-bordered table-striped"><!--table start-->
          <thead>
            <tr>
              <th> Weight From:</th>
              <th> Weight To:</th>
          ...
          <tbody>
            ...
            if (isset($_GET['zone_id'])) {
              $get_shipping_rates = "select * from shipping where shipping_type='$type_id'
              and shipping_zone='$zone_id' order by shipping_weight";

            }elseif (isset($_GET['country_id'])) {
              $get_shipping_rates = "select * from shipping where shipping_type='$type_id'
              and shipping_country='$country_id' order by shipping_weight";
            }
            ...
            while ($row_shipping_rates = mysqli_fetch_array($run_shipping_rates)) {
              ...
              if ($i ==1) {
                ...
                $shipping_weight_from = $shipping_weights[$previous_shipping_id] + 0.01;
              }
             ...
             <tr id="tr_<?php echo $shipping_id; ?>">
               ...
               <td> <?php echo $shipping_cost; ?> Lekë</td>
               <td>
