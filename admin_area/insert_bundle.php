                  ...
                  <div class="form-group"><!-- form-group starts -->
                    <label class="control-label"> Bundle URL </label>
                      ...
                      <p style="font-size: 15px; font-weight: bold;">
                        Example Product Url : Samsung-RB37J5820SA
                      </p>
                  </div><!-- form-group ends -->
...
<?php
 if (isset($_POST['submit'])) {
   ...
   values ('$product_cat', '$cat','$manufacturer_id', NOW(),'$product_title','$product_seo_description','$product_url', '$product_code','$product_img1','$product_img2','$product_img3','$product_price','$psp_price',
   ...
   if ($run_product){
    ...
    $run_product_stock = mysqli_query($con, $insert_product_stock);
     ...
     echo "<script> alert('Bundle inserted successfully')</script>";
