...
<body>
                ...
                <div class="col-md-9 col-sm-12"><!-- col-md-9 starts -->
                  ...
                  <div class="form-group"><!-- form-group starts -->
                    <label class="control-label"> Produkt URL </label>
                      <input type="text" name="product_url" class="form-control" value="<?php echo $p_url; ?>">
                      <br>
                      <p style="font-size: 15px; font-weight: bold;">
                        Shembull Produk Url : Samsung-RB37J5820SA
                      </p>
                  </div><!-- form-group ends -->
                   ...
                   <label class="control-label"> Te dhenat e Produktit </label>
                     ...
                     <div class="tab-content"><!--tab-content start -->
                       <div id="description" class="tab-pane fade in active"><!--tab-pane start -->
                         <br>
                         <textarea name="product_desc" class="form-control" rows="15" id="product_description"><?php echo $p_desc; ?></textarea>
                       </div><!--tab-pane end -->
                       ...
                       <div id="video" class="tab-pane fade in"><!--tab-pane start -->
                         <br>
                         <textarea name="product_video" class="form-control" rows="15" id="product_video"><?php echo $p_video; ?></textarea>
                       </div><!--tab-pane end -->
                 ...
                 <div class="form-group"><!-- form-group starts -->
                   <label class="control-label"> Çmimi Zbritur </label>
                     <input type="text" name="psp_price" class="form-control" value="<?php echo trim($psp_price); ?> ">
                 </div><!-- form-group ends -->

                </div><!-- col-md-9 end -->

                <div class="col-md-3 col-sm-12"><!-- col-md-3 starts -->
                  ...
                  <div class="form-group"><!-- form-group starts -->
                    <label class="control-label"> Zgjidhni Marken </label>
                     <select name="manufacturer" class="form-control">
                      ...
                      <img src="http://placehold.jp/250x250.png" width="70" height="70">
                      <?php }else{ ?>
                    ...
                    <label class="control-label"> Etiketa e Produktit </label>
                      <input type="text" name="product_label" class="form-control" value="<?php echo trim($p_label); ?> ">
                  </div><!-- form-group ends -->
  ...
  <script>
    $(document).ready(function() {
      ...
      <?php if($_SERVER["QUERY_STRING"]== "edit_product=$random_id"){ ?>
...
<?php
 if (isset($_POST['update'])) {
   ...
   product_seo_desc='$product_seo_description', product_url='$product_url', product_code='$product_code',
