		...
		<div class="panel panel-default"><!--panel panel-default start-->
           ...
           <div class="form-group"><!--form-group start-->
				   	 ...
				   	 <div class="col-md-6">
				   	 	...
				   	 	">
              <br />
              <img src="services_images/<?php echo $service_image; ?>" alt="" width="70" height="70">
				   	 </div>
				   </div><!--form-group end-->
				   ...
				   <div class="form-group"><!--form-group start-->
				   	 ...
				   	 <div class="col-md-6">
						<textarea type="text" name="service_desc" class="form-control" rows="15" cols="19">
...
<?php
    ...
    $update_services = "update services set service_title='$service_title',service_image='$service_image',
    service_desc='$service_desc',service_button='$service_button',service_url='$service_url' where service_id='$service_id' ";
