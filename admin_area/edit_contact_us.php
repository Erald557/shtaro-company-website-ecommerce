...
<div class="panel-body"><!-- panel-body Starts -->
  ...
  <form class="form-horizontal" action="" method="post"><!-- form-horizontal Starts -->
    ...
    <div class="form-group"><!-- form-group Starts -->
      ...
      <div class="col-md-6">
      <textarea name="contact_desc" class="form-control" rows="6" cols="19"><?php echo $contact_desc; ?>
      </textarea>
      </div>
    </div><!-- form-group end -->
    <div class="form-group"><!-- form-group Starts -->
...
<?php
  if (isset($_POST['submit'])) {
    ...
    $update = "update contact_us set contact_email='$contact_email', contact_heading='$contact_heading',
    contact_desc='$contact_desc' ";
    $run_contact_us = mysqli_query($con,$update);
    if ($run_contact_us) {
