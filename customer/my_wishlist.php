...
<center><!-- center start-->
  <h1>Lista e Dëshirave</h1>
  <p class="lead"> Produktet tuaja të Listës së Dëshirave</p>
</center><!-- center end-->
<hr />
<div class="table-responsive"><!-- table-responsive start -->
  <table class="table table-bordered table-hover"><!-- table table-bordered table-hover start -->
    <thead>
      <tr>
        <th>Nr i Listës së Dëshirave :</th>
        <th>Produkti i Listës së Dëshirave </th>
        <th>Fshi Listën e Dëshirave</th>
      </tr>
    </thead>
    <tbody>
      <?php
      ...
      while ($row_wishlist = mysqli_fetch_array($run_wishlist)) {
       ...
       <tr>
         ...
         <td>
           <img src="../admin_area/product_images/<?php echo $product_img1; ?>" alt="" width="60" height="60">
           &nbsp;&nbsp;&nbsp;
